...
| `IV-benches.jpg` | IV | Seven legislators, each with a shoulder bag and a ledger. |
| `IV-legislators.jpg` | IV | Five legislators: one with an hourglass, one gesturing, one seated on a stone seat, one reading a ledger. |
| `IV-ledger.jpg` | IV | Ledger studies: closed and open volumes, ruled and struck-through entries, a tally scrap. |
...
## Where the sheets disagree with the current canon
The canon on `art-direction-grand-island-shape.html` wins.
- **The ledger is a parchment scroll on two rods**, not a bound codex. These sheets still show codex books and are due to be regenerated with `tools/reference_sheets.py` (prompts in `prompts/reference-sheets.md`):
  - `IV-ledger.jpg`, `IV-benches.jpg` and `IV-legislators.jpg`.
  - `IV-symbols.jpg`, whose ninth pictogram is a book.
